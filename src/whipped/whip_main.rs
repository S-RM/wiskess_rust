...
pub(crate) fn set_link(link: &str, folder: &str) -> String {
...
pub(crate) fn split_and_trim(data_source_list: &str) -> Vec<String> {
...
pub(crate) fn print_log(msg: &str, out_log:&Path, verbose: bool) {
    if verbose {
        println!("{msg}")
    }
...
pub(crate) fn url_to_path(url: &String) -> String {
    let parts = url.split("/");
